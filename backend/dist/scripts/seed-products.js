...
const products = departments.flatMap((department, departmentIndex) => department.brands.flatMap((brand, brandIndex) => department.items.flatMap((item, itemIndex) => (department.category === "Dry Fruits"
    ? department.variants
    : [
        ...department.variants,
...
const result = await Product.bulkWrite([...products, ...brandedProducts, ...marketplaceProducts].map((product) => ({
    updateOne: {
