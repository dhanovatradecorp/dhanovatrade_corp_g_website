...
try {
    ...
    const donors = products.filter((product) => product.images?.length &&
        product.specifications
            ?.imageSource !== SOURCE_LABEL);
    const updates = targets.flatMap((product) => {
        ...
        const sameSubcategory = categoryDonors.filter((donor) => product.subcategory &&
