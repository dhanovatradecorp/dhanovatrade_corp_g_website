...
const DEFAULT_PATH = path.join(
  homedir(),
  "Downloads",
  "Biscuits_IceCreams_CoolDrinks_Catalogue_300.xlsx",
);
...
if (products.length !== 300)
  throw new Error(
    `Expected 300 catalogue products but parsed ${products.length}.`,
  );
...
try {
  ...
  console.log(
    `Biscuits/Ice Cream/Cool Drinks import: ${result.upsertedCount} inserted, ${result.modifiedCount} updated.`,
  );
